...
describe('GET /rest', () => {
    ...
    test('Autos mit einer Teil-Bezeichnung suchen', async () => {
        // given
        ...
        // Jedes Auto hat eine Bezeichnung mit dem Teilstring 'a'
        autos
    ...
    test('Autos zu einer nicht vorhandenen Teil-Bezeichnung suchen', async () => {
        // given
